...
namespace ProyectoXport.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public EmpleadoesController(AguaxportContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar)
        {
            ...
            {
                empleados = empleados.Where(s => s.Nombre!.Contains(buscar));
            }
        ...
        public async Task<IActionResult> Create([Bind("IdEmpleado,Nombre,Telefono,Direccion,IdCargo")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmpleado,Nombre,Telefono,Direccion,IdCargo")] Empleado empleado)
        {
