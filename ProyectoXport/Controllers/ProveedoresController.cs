...
namespace ProyectoXport.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(AguaxportContext context)
        {
            _context = context;
        }
        ...
        {
            var proveedores = from proveedor in _context.Proveedores select proveedor;

            if (!String.IsNullOrEmpty(buscar))
            {
                proveedores = proveedores.Where(s => s.Nombre!.Contains(buscar));
            }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Nombre,Telefono,Direccion")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,Nombre,Telefono,Direccion")] Proveedore proveedore)
        {
