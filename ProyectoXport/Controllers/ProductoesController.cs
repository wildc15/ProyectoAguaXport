...
namespace ProyectoXport.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ProductoesController(AguaxportContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,Nombre,Precio,Stock,IdProveedor")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,Nombre,Precio,Stock,IdProveedor")] Producto producto)
        {
